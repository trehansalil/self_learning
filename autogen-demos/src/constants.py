...
EURI_API_KEY = LOAD_ENV("EURI_API_KEY", "EMPTY")
EURI_API_BASE_URL = LOAD_ENV("EURI_API_BASE_URL", "")

EURI_MODEL_NAME_GPT_4_1_NANO = LOAD_ENV("EURI_MODEL_NAME_GPT_4_1_NANO", "")
EURI_MODEL_NAME_GPT_4_1_MINI = LOAD_ENV("EURI_MODEL_NAME_GPT_4_1_MINI", "")
EURI_MODEL_NAME_GEMINI_2_0_FLASH = LOAD_ENV("EURI_MODEL_NAME_GEMINI_2_0_FLASH", "")
EURI_MODEL_NAME_GEMINI_2_5_PRO = LOAD_ENV("EURI_MODEL_NAME_GEMINI_2_5_PRO", "")
EURI_MODEL_NAME_LLAMA_SCOUT = LOAD_ENV("EURI_MODEL_NAME_LLAMA_SCOUT", "")
